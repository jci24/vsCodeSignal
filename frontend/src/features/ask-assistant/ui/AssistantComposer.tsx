  ...
  return (
    ...
    >
      <textarea
        className={
          compact
            ? 'min-h-14 rounded-[1.4rem] border border-border/70 bg-background/80 px-4 py-2.5 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:border-foreground/30'

...
export function WorkspaceShell() {
  ...
  const isCompareRoute = activeTitle === 'Compare'
  const isAdvancedRoute = activeTitle === 'Inspect'

  return (
    <div className="min-h-svh overflow-hidden bg-background p-4">
      <div className="flex h-[calc(100svh-2rem)] flex-col md:flex-row">
        <aside
          className={cn(
        ...
        >
          ...
          <nav aria-label="Primary navigation" className="min-h-0 flex-1 overflow-y-auto p-4">
            ...
            <div
              className={cn(
                'mt-6 rounded-2xl border border-border/70 bg-secondary/25 p-4',
                isCollapsed ? 'md:p-4' : '',
              )}
            >
              <div
              ...
              >
                ...
                <div className={cn('space-y-2', isCollapsed ? 'md:hidden' : 'block')}>
              ...
              <div className={cn('mt-4', isCollapsed ? 'md:mt-4' : '')}>
        ...
        <main className="flex min-h-0 min-w-0 flex-1 overflow-hidden">
          <div className="flex min-h-full w-full flex-1 flex-col overflow-hidden px-6 py-4 md:px-8 md:pt-0 md:pb-4">
            ...
            <div
              className={cn(
                ...
                isCompareRoute ? 'overflow-x-hidden overflow-y-auto' : 'overflow-hidden',
              )}
            >
              <Outlet />
            </div>
